...
export class WeixinConfigStore {
  ...
  async load() {
    try {
      ...
      if (!normalized) throw new Error('dsh-message-weixin config contains invalid account data');
  ...
  async save(value) {
    ...
    if (!normalized) throw new Error('Refusing to persist incomplete dsh-message-weixin account data');
