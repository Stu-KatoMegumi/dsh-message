...
export class DingtalkConfigStore {
  ...
  async load() {
    try {
      ...
      if (!normalized) throw new Error('dsh-message-dingtalk config contains invalid bot data');
  ...
  async save(value) {
    ...
    if (!normalized) throw new Error('Refusing to persist invalid dsh-message-dingtalk bot data');
