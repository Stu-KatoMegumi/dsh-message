  ...
  return h2(
    ...
    h2(
      ...
      routing ? h2(
        ...
        h2("strong", null, `\u5F53\u524D\u8DEF\u7531\uFF1A${routing.active === "fallback" ? "Flash \u515C\u5E95" : "Qwen \u4E3B\u6A21\u578B"}`),
        h2(
          "small",
          null,
          `\u4E3B\u8DEF\u7531 ${routeLabel(routing.primary?.fast)} / ${routeLabel(routing.primary?.deep)}\uFF1B\u515C\u5E95 ${routeLabel(routing.fallback?.fast)} / ${routeLabel(routing.fallback?.deep)}`
        )
      ) : null
    ),
    h2(
